              ...
              belowComponent: () => {
                return (
                  <div style={{ marginTop: "19px" }}>
                    ...
                    <CardSectionHeader style={{ marginBottom: "16px", color: "#0B0C0C", fontSize: "16px", marginTop: "revert" }}>
                    ...
                    <div style={{ border: "1px solid #D6D5D4", padding: "16px", marginTop: "8px", borderRadius: "4px", background: "#FAFAFA" }}>
                      <div className="row border-none">
                        <h2>{t("PT_APPLICABLE_CHARGE_SLABS")}</h2>
                      </div>
                    ...
                    <div className="value">{t("PT_RATE")}</div>
                      ...
                      <StatusTable>
                        {applicationDetails?.applicationData?.units
                          ...
                          ?.map((unit, index) => (
                            <Row
                              label={`${t(`PROPERTYTAX_FLOOR_${unit?.floorNo}`)} ${t(`PT_UNIT`)} - ${index + 1}`}
                              text={
                                ChargeSlabsMenu?.PropertyTax &&
                                ChargeSlabsMenu?.PropertyTax?.ChargeSlabs?.filter((ob) => ob.floorNo == unit.floorNo)?.[0]?.name
                              }
                            />
                          ))}
                      </StatusTable>
